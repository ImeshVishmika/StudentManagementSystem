...
public class StudentRegister extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText(" Select Students Grade");
        ...
        jPanel10Layout.setVerticalGroup(
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(subPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 123, Short.MAX_VALUE)
                .addGap(18, 18, 18)
    ...
    private void registerBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerBtnActionPerformed
        ...
        if (x > 0) {
            ...
            if (data.verifyData(nic.getText(), email.getText())) {
                Student s = new Student(id, fname, lname, mail, gender,selectedSubjects);
                boolean success = data.addData(s);
                if (success == true) {
