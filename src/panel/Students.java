...
public class Students extends javax.swing.JPanel {
    ...
    public Students() {
        ...
        loadTable();
         ...
         addStudent.putClientProperty(FlatClientProperties.STYLE, "arc:15");
         deleteStudent.putClientProperty(FlatClientProperties.STYLE, "arc:15");
    ...
    private void initComponents() {
        ...
        addStudent.setBackground(new java.awt.Color(19, 115, 51));
        ...
        deleteStudent.setBackground(new java.awt.Color(179, 38, 30));
