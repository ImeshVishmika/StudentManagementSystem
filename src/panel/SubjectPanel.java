...
public class SubjectPanel extends javax.swing.JPanel {
    ...
    private void loadTable() {
        model.setRowCount(0);
        List<Subject> subject = data.loadData(searchField.getText());
        for (Subject s : subject) {
            model.addRow(new Object[]{s.getSubjectName(), s.getTeachersName(),s.getGrade()});
        }
    }
